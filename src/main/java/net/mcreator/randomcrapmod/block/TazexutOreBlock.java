...
import net.mcreator.randomcrapmod.item.TazexutItem;
...
public class TazexutOreBlock extends RandomCrapModModElements.ModElement {
	@ObjectHolder("random_crap_mod:tazexut_ore")
	public static final Block block = null;

	public TazexutOreBlock(RandomCrapModModElements instance) {
		super(instance, 9);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TazexutItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("random_crap_mod:tazexut_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("tazexut_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("random_crap_mod:tazexut_ore"), configuredFeature);
		}
	}
