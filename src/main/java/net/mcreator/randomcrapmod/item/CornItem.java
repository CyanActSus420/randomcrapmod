...
import net.mcreator.randomcrapmod.procedures.CornRightclickedOnBlockProcedure;
...
public class CornItem extends RandomCrapModModElements.ModElement {
	@ObjectHolder("random_crap_mod:corn")
	public static final Item block = null;

	public CornItem(RandomCrapModModElements instance) {
		super(instance, 30);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("summons bambi fnf (also turn down the volume when using it lmao)"));
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			CornRightclickedOnBlockProcedure.executeProcedure(Stream
