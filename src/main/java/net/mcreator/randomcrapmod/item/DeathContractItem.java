...
import net.mcreator.randomcrapmod.gui.DeathContractGUIGuiWindow;
import net.mcreator.randomcrapmod.gui.DeathContractGUIGui;
...
public class DeathContractItem extends RandomCrapModModElements.ModElement {
	@ObjectHolder("random_crap_mod:death_contract")
	public static final Item block = null;

	public DeathContractItem(RandomCrapModModElements instance) {
		super(instance, 32);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof DeathContractGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(CreativeTabItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("death_contract");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Death Contract");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new DeathContractGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
